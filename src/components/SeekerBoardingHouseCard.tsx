...
import { MapPin, Tag, Users, CheckCircle } from 'lucide-react';
...
const SeekerBoardingHouseCard: React.FC<SeekerBoardingHouseCardProps> = ({ house }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
      <img
        src={house.imageUrl}
        alt={house.name}
