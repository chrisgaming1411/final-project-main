          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {isAuthenticated ? (
              <>
                ...
                <button onClick={() => setIsLogoutModalOpen(true)} className="text-lg text-white hover:text-brand-light-cyan transition-colors">
                  Logout
                </button>
              </>
            ) : (
            ...
            <nav className="flex flex-col items-center space-y-4 py-6">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <button onClick={() => { setIsLogoutModalOpen(true); setIsMenuOpen(false); }} className="text-lg text-white hover:text-brand-light-cyan transition-colors">
                    Logout
                  </button>
                </>
              ) : (
